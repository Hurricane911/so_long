...
check_error_map "maps_err/.ber" "Bad extension" #8 Hidden file, not extension ber //this
...
check_error_map "maps_err/no_valid_road.ber" "Duplicate exit" #24 //map_problem
